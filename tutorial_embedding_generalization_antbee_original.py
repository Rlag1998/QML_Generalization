"""
Generalization of Quantum Metric Learning Classifiers (Ants & Bees Image Dataset without PCA)
======================================
...
# data preparation file in the `embedding_metric_learning folder <https://github.com/Rlag1998/QML_Generalization/tree/main/embedding_metric_learning>`_).
