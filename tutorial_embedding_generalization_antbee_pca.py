...
.. meta::
    ...
    :property="og:image": https://github.com/Rlag1998/QML_Generalization/blob/main/embedding_metric_learning/figures/All_Figures/1.3.2.png?raw=true
...
entanglers, as well as RX and RY rotation gates. This results in ``2n + 12`` total parameters 
