...
.. meta::
    ...
    :property="og:image": https://github.com/Rlag1998/QML_Generalization/blob/main/embedding_metric_learning/figures/All%20Figures/1.1.4.png
...
Data preparation is handled by the ``antbees_original.py`` file in the ``embedding_metric_learning`` folder.
...
# data preparation file in the ``embedding_metric_learning`` folder).
